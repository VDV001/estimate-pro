        ...
        <Card className="border-border/50 shadow-xl backdrop-blur-sm">
          ...
          <CardContent className="space-y-4 pt-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <a href={`${process.env.NEXT_PUBLIC_API_URL ?? "http://localhost:8080"}/api/v1/auth/oauth/google`}>
              ...
              <a href={`${process.env.NEXT_PUBLIC_API_URL ?? "http://localhost:8080"}/api/v1/auth/oauth/github`}>
                <Button variant="outline" className="w-full gap-2" type="button">
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="name" name="name" type="text" className="pl-10" required />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="email" name="email" type="email" placeholder="email@example.com" className="pl-10" required />
                </div>
              </div>
