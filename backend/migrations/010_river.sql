-- +goose Up
-- River job queue schema (v0.35.1, migrations 001-006 consolidated).
-- Template schema prefix removed — all tables use the default search_path.
...
-- 005: migration table (line, version)
DO
$body$
BEGIN
